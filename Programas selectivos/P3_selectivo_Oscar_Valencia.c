...
int main(){
    ...
    if (a<0 || b<0 || c<0){
        ...
        if ((a+b)>c && (c+b)>a && (a+c)>b){
            ...
            scanf(" %c", &opc);
            if (opc == 'p' || opc == 'P'){
                printf("El perimetro del triangulo es %.3f u\n", a+b+c);
                if (a == b == c){
                    printf("El triangulo es equilatero, con sus lados %.3f, %.3f, %.3f\n", a,b,c);
                } else if ((a == b || a == c || b == c)){
                    printf("El triangulo es isosceles, con sus lados %.3f, %.3f, %.3f\n", a,b,c);
                } else{
                    printf("El triangulo es escaleno, con sus lados %.3f, %.3f, %.3f\n", a,b,c);
                }
            }else if (opc == 'a' || opc == 'A'){
                sp=(a+b+c)/2;
                area=sqrt(sp*(sp-a)*(sp-b)*(sp-c));
                printf("El area del traingulo es: %.3f u^2\n", area);
                if (a == b == c){
                    printf("El triangulo es equilatero, con sus lados %.3f, %.3f, %.3f\n", a,b,c);
                } else if ((a == b || a == c || b == c)){
                    printf("El triangulo es isosceles, con sus lados %.3f, %.3f, %.3f\n", a,b,c);
